...
--
-- Table structure for table `tajob`
--
...
CREATE TABLE `tajob` (
  ...
  `ta_courses_selection_hidden` varchar(255) DEFAULT NULL,
  ...
  `expected_time_dutation` varchar(255) DEFAULT NULL,
  `tajob_publisher_id` bigint DEFAULT NULL,
...
-- Dump completed on 2025-09-05  2:59:58
