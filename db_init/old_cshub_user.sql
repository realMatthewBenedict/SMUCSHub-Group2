...
CREATE TABLE `user` (
  ...
  `service_provider` tinyint(1) NOT NULL DEFAULT '0',
  `expertises` longtext,
  `categories` longtext,
  `detail` varchar(255) DEFAULT NULL,
  `user_type` int DEFAULT NULL,
  `service_execution_counts` bigint NOT NULL,
  `service_user` tinyint(1) NOT NULL DEFAULT '0',
  `create_time` varchar(255) DEFAULT NULL,
  `is_active` varchar(255) DEFAULT NULL,
  `project_zone_id` bigint DEFAULT NULL,
...
-- Dump completed on 2025-09-05  2:59:08
