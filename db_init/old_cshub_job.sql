...
CREATE TABLE `job` (
  ...
  `jobtxt` varchar(255) DEFAULT NULL,
  ...
  `job_publisher_id` bigint DEFAULT NULL,
  ...
  `minimum_degree` varchar(255) DEFAULT NULL,
  `minimum_degree_in_fields` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2025-09-05  2:59:59
